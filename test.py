...
class TestMarp(unittest.TestCase):
    ...
    def test_apex2marp_norotation(self):
        ...
        alat, alon = np.meshgrid(np.arange(-90., 91., 1.), np.arange(-180., 181., 2.))
    ...
    def test_marp2apex_norotation(self):
        ...
        marp = Marp(date=2019, lam0=0., phi0=0.)
        mlat, mlon = np.meshgrid(np.arange(-90., 91., 1.), np.arange(-180., 181., 2.))
    ...
    def test_geo2marp(self):
        ...
        glat0, glon0 = np.meshgrid(np.arange(-89., 90., 2.), np.arange(-179., 180., 4.))
    ...
    def test_marp2geo(self):
        ...
        mlat0, mlon0 = np.meshgrid(np.arange(-89., 90., 2.), np.arange(-179., 180., 4.))
    ...
    def test_basevectors_norotation(self):
    ...
    def test_basevectors_reciprocal(self):
    ...
    def test_basevectors_scaled(self):
    ...
    def test_basevectors_parallel2B(self):
        ...
        marp = Marp(date=2019, lam0=60., phi0=30.)
        glat, glon = np.meshgrid(np.arange(-90., 90., 10.), np.arange(-180., 180., 30.))
    ...
    def test_basevectors_construction(self):
    ...
    def test_mapping(self):
        ...
        self.assertAlmostEqual(Ed1A, Ed1B, places=3)
        self.assertAlmostEqual(Ed2A, Ed2B, places=3)
        self.assertAlmostEqual(Ve1A, Ve1B, places=3)
        self.assertAlmostEqual(Ve2A, Ve2B, places=3)
