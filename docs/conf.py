...
project = 'marppy'
copyright = '2022, Leslie J. Lamarche, Roger H. Varney'
author = 'Leslie J. Lamarche, Roger H. Varney'
...
MOCK_MODULES = ['apexpy']
sys.modules.update((mod_name, Mock(Apex=object)) for mod_name in MOCK_MODULES)
